...
void Record2buffer(char * buff,int len){
				...
				snprintf(buff,len, "%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n",t,x_raw[0],x_raw[1],x_raw[2],q_raw[0],q_raw[1],q_raw[2],q_raw[3],a_raw[0],a_raw[1],a_raw[2],w_raw[0],w_raw[1],w_raw[2],x[0],x[1],x[2],q[0],q[1],q[2],q[3],v[0],v[1],v[2],a[0],a[1],a[2],w[0],w[1],w[2],Fd,u[0],u[1],u[2],u[3],M[0],M[1],M[2]);
